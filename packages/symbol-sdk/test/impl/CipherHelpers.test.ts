...
import { concatArrays, decodeAesCbc, decodeAesGcm, encodeAesCbc, encodeAesGcm } from '../../src/impl/CipherHelpers.js';
...
describe('CipherHelpersのテスト', () => {
  ...
  describe('AES-CBC暗号化と復号化', () => {
    it('メッセージを暗号化して復号化できる', async () => {
      ...
      // 復号化
      const decrypted = await decodeAesCbc(mockDeriveSharedKeyWithSalt, keyPair, recipientPublicKey, encodedMessage);
