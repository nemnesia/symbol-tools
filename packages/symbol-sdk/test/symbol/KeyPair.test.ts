...
describe('KeyPairのテスト', () => {
  const TEST_PRIVATE_KEY = new PrivateKey(
    new Uint8Array([
      0x8d, 0x31, 0xb7, 0x12, 0xab, 0x28, 0xd4, 0x9f, 0xae, 0xb2, 0x9a, 0xe9, 0x7e, 0x38, 0xde, 0x9d, 0x4e, 0x8d, 0xb9,
      0x6d, 0x4e, 0x9d, 0xd7, 0x6c, 0xe0, 0x57, 0xb5, 0x8e, 0x32, 0xa9, 0x77, 0xed,
    ])
  );
