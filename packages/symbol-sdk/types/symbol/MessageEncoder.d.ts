...
export default class MessageEncoder {
     ...
     */
    tryDecode(recipientPublicKey: PublicKey, encodedMessage: Uint8Array): Promise<TryDecodeResult>;
    /**
     ...
     */
    encode(recipientPublicKey: PublicKey, message: Uint8Array): Promise<Uint8Array>;
    /**
     ...
     */
    encodePersistentHarvestingDelegation(nodePublicKey: PublicKey, remoteKeyPair: KeyPair, vrfKeyPair: KeyPair): Promise<Uint8Array>;
    /**
     * Tries to decode encoded message.
     ...
     * @returns {Promise<TryDecodeResult>} Tuple containing decoded status and message.
     */
    tryDecodeDeprecated(recipientPublicKey: PublicKey, encodedMessage: Uint8Array): Promise<TryDecodeResult>;
    /**
     ...
     * @returns {Promise<Uint8Array>} Encrypted and encoded message.
     */
    encodeDeprecated(recipientPublicKey: PublicKey, message: Uint8Array): Promise<Uint8Array>;
}
/**
