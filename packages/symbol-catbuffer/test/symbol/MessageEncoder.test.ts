...
describe('MessageEncoder', () => {
	...
	describe('encode/tryDecode', () => {
		it('メッセージをエンコード/デコードできる', async () => {
			...
			const recipientKeyPair = new KeyPair(new PrivateKey('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'));
		...
		it('空のメッセージをエンコード/デコードできる', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'));
		...
		it('長いメッセージをエンコード/デコードできる', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC'));
		...
		it('不正なエンコードされたメッセージをデコードできない', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD'));
		...
		it('間違った受信者でデコードできない', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE'));
			const wrongRecipientKeyPair = new KeyPair(new PrivateKey('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF'));
		...
		it('エンコードされたメッセージは0x01で始まる', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('1111111111111111111111111111111111111111111111111111111111111111'));
	...
	describe('encodePersistentHarvestingDelegation', () => {
		it('ハーベスティングデリゲーションリクエストをエンコードできる', async () => {
			const encoder = createEncoder();
			const nodePublicKey = new KeyPair(new PrivateKey('2222222222222222222222222222222222222222222222222222222222222222')).publicKey;
			const remoteKeyPair = new KeyPair(new PrivateKey('3333333333333333333333333333333333333333333333333333333333333333'));
			const vrfKeyPair = new KeyPair(new PrivateKey('4444444444444444444444444444444444444444444444444444444444444444'));
		...
		it('デリゲーションメッセージをデコードできる', async () => {
			const encoder = createEncoder();
			const nodeKeyPair = new KeyPair(new PrivateKey('5555555555555555555555555555555555555555555555555555555555555555'));
			const remoteKeyPair = new KeyPair(new PrivateKey('6666666666666666666666666666666666666666666666666666666666666666'));
			const vrfKeyPair = new KeyPair(new PrivateKey('7777777777777777777777777777777777777777777777777777777777777777'));

			const encoded = await encoder.encodePersistentHarvestingDelegation(nodeKeyPair.publicKey, remoteKeyPair, vrfKeyPair);
	...
	describe('deprecated methods', () => {
		it('encodeDeprecatedでエンコードできる', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('8888888888888888888888888888888888888888888888888888888888888888'));
		...
		it('tryDecodeDeprecatedでデコードできる', async () => {
			const encoder = createEncoder();
			const recipientKeyPair = new KeyPair(new PrivateKey('9999999999999999999999999999999999999999999999999999999999999999'));
