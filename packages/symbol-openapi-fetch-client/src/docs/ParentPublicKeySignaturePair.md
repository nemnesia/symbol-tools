...
```typescript
import type { ParentPublicKeySignaturePair } from ''
...
,
} satisfies ParentPublicKeySignaturePair
...
const exampleParsed = JSON.parse(exampleJSON) as ParentPublicKeySignaturePair
