...
```typescript
import type { EmbeddedTransactionInfoDTOTransaction } from ''
...
const example = {
  ...
  "mosaics": null,
  "message": null,
} satisfies EmbeddedTransactionInfoDTOTransaction
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedTransactionInfoDTOTransaction
