...
```typescript
import type { EmbeddedMosaicMetadataTransactionDTO } from ''
...
const example = {
  ...
  "value": null,
} satisfies EmbeddedMosaicMetadataTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedMosaicMetadataTransactionDTO
