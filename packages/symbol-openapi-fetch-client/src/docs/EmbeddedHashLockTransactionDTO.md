...
```typescript
import type { EmbeddedHashLockTransactionDTO } from ''
...
} satisfies EmbeddedHashLockTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedHashLockTransactionDTO
