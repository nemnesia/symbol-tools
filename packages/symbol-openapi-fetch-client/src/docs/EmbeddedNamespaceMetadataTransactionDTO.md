...
```typescript
import type { EmbeddedNamespaceMetadataTransactionDTO } from ''
...
const example = {
  ...
  "value": null,
} satisfies EmbeddedNamespaceMetadataTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedNamespaceMetadataTransactionDTO
