...
```typescript
import type { MosaicMetadataTransactionDTO } from ''
...
,
  ...
  "value": null,
} satisfies MosaicMetadataTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as MosaicMetadataTransactionDTO
