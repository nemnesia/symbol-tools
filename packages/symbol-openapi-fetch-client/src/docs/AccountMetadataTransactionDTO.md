...
```typescript
import type { AccountMetadataTransactionDTO } from ''
...
,
  ...
  "value": null,
} satisfies AccountMetadataTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as AccountMetadataTransactionDTO
