...
```typescript
import type { MosaicMetadataTransactionBodyDTO } from ''
...
const example = {
  ...
  "value": null,
} satisfies MosaicMetadataTransactionBodyDTO
...
const exampleParsed = JSON.parse(exampleJSON) as MosaicMetadataTransactionBodyDTO
