 ...
 */
export function instanceOfAccountOperationRestrictionTransactionDTO(
  value: object
): value is AccountOperationRestrictionTransactionDTO {
...
export function AccountOperationRestrictionTransactionDTOFromJSON(
  json: any
