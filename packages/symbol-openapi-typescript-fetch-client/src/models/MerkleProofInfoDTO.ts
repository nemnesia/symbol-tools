...
export function MerkleProofInfoDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): MerkleProofInfoDTO {
  ...
  return {
    merklePath:
      json['merklePath'] == null ? undefined : (json['merklePath'] as Array<any>).map(MerklePathItemDTOFromJSON),
  };
}
...
export function MerkleProofInfoDTOToJSONTyped(
  value?: MerkleProofInfoDTO | null,
  ...
  return {
    merklePath:
      value['merklePath'] == null ? undefined : (value['merklePath'] as Array<any>).map(MerklePathItemDTOToJSON),
  };
}
