...
export function ChainPropertiesDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChainPropertiesDTO {
  ...
  return {
    ...
    blockGenerationTargetTime:
      json['blockGenerationTargetTime'] == null ? undefined : json['blockGenerationTargetTime'],
    ...
    blockFinalizationInterval:
      json['blockFinalizationInterval'] == null ? undefined : json['blockFinalizationInterval'],
    importanceGrouping: json['importanceGrouping'] == null ? undefined : json['importanceGrouping'],
    importanceActivityPercentage:
      json['importanceActivityPercentage'] == null ? undefined : json['importanceActivityPercentage'],
    ...
    defaultDynamicFeeMultiplier:
      json['defaultDynamicFeeMultiplier'] == null ? undefined : json['defaultDynamicFeeMultiplier'],
    ...
    initialCurrencyAtomicUnits:
      json['initialCurrencyAtomicUnits'] == null ? undefined : json['initialCurrencyAtomicUnits'],
    ...
    harvestBeneficiaryPercentage:
      json['harvestBeneficiaryPercentage'] == null ? undefined : json['harvestBeneficiaryPercentage'],
    ...
    harvestNetworkFeeSinkAddress:
      json['harvestNetworkFeeSinkAddress'] == null ? undefined : json['harvestNetworkFeeSinkAddress'],
...
export function ChainPropertiesDTOToJSONTyped(
  value?: ChainPropertiesDTO | null,
