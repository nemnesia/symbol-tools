 ...
 */
export function instanceOfMultisigAccountModificationTransactionDTO(
  value: object
): value is MultisigAccountModificationTransactionDTO {
...
export function MultisigAccountModificationTransactionDTOFromJSON(
  json: any
