...
export function NamespaceNetworkPropertiesDTOFromJSONTyped(
  json: any,
  ...
  return {
    ...
    namespaceGracePeriodDuration:
      json['namespaceGracePeriodDuration'] == null ? undefined : json['namespaceGracePeriodDuration'],
    reservedRootNamespaceNames:
      json['reservedRootNamespaceNames'] == null ? undefined : json['reservedRootNamespaceNames'],
    namespaceRentalFeeSinkAddress:
      json['namespaceRentalFeeSinkAddress'] == null ? undefined : json['namespaceRentalFeeSinkAddress'],
    rootNamespaceRentalFeePerBlock:
      json['rootNamespaceRentalFeePerBlock'] == null ? undefined : json['rootNamespaceRentalFeePerBlock'],
