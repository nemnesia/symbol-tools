...
export function AggregateNetworkPropertiesDTOFromJSONTyped(
  json: any,
  ...
  return {
    maxTransactionsPerAggregate:
      json['maxTransactionsPerAggregate'] == null ? undefined : json['maxTransactionsPerAggregate'],
    maxCosignaturesPerAggregate:
      json['maxCosignaturesPerAggregate'] == null ? undefined : json['maxCosignaturesPerAggregate'],
    enableStrictCosignatureCheck:
      json['enableStrictCosignatureCheck'] == null ? undefined : json['enableStrictCosignatureCheck'],
    enableBondedAggregateSupport:
      json['enableBondedAggregateSupport'] == null ? undefined : json['enableBondedAggregateSupport'],
    maxBondedTransactionLifetime:
      json['maxBondedTransactionLifetime'] == null ? undefined : json['maxBondedTransactionLifetime'],
  };
}
