 ...
 */
export function instanceOfMosaicGlobalRestrictionEntryRestrictionDTO(
  value: object
): value is MosaicGlobalRestrictionEntryRestrictionDTO {
...
export function MosaicGlobalRestrictionEntryRestrictionDTOFromJSON(
  json: any
...
export function MosaicGlobalRestrictionEntryRestrictionDTOToJSON(
  json: any
): MosaicGlobalRestrictionEntryRestrictionDTO {
