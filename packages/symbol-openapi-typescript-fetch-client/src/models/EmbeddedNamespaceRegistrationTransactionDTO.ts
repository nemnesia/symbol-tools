 ...
 */
export function instanceOfEmbeddedNamespaceRegistrationTransactionDTO(
  value: object
): value is EmbeddedNamespaceRegistrationTransactionDTO {
...
export function EmbeddedNamespaceRegistrationTransactionDTOFromJSON(
  json: any
...
export function EmbeddedNamespaceRegistrationTransactionDTOToJSON(
  json: any
): EmbeddedNamespaceRegistrationTransactionDTO {
