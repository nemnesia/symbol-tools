...
export function instanceOfImportanceBlockDTO(value: object): value is ImportanceBlockDTO {
  ...
  if (!('harvestingEligibleAccountsCount' in value) || value['harvestingEligibleAccountsCount'] === undefined)
    return false;
...
export function ImportanceBlockDTOToJSONTyped(
  value?: ImportanceBlockDTO | null,
