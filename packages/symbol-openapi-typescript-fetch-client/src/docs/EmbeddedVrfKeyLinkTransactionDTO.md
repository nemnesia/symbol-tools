...
```typescript
import type { EmbeddedVrfKeyLinkTransactionDTO } from ''
...
const example = {
  ...
  "linkAction": null,
} satisfies EmbeddedVrfKeyLinkTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedVrfKeyLinkTransactionDTO
