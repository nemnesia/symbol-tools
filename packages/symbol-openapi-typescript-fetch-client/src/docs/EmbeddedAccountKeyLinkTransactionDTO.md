...
```typescript
import type { EmbeddedAccountKeyLinkTransactionDTO } from ''
...
const example = {
  ...
  "linkAction": null,
} satisfies EmbeddedAccountKeyLinkTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedAccountKeyLinkTransactionDTO
