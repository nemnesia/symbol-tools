...
```typescript
import type { AccountAddressRestrictionTransactionBodyDTO } from ''
...
} satisfies AccountAddressRestrictionTransactionBodyDTO
...
const exampleParsed = JSON.parse(exampleJSON) as AccountAddressRestrictionTransactionBodyDTO
