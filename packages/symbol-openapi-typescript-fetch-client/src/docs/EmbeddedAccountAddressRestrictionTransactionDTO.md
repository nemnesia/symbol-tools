...
```typescript
import type { EmbeddedAccountAddressRestrictionTransactionDTO } from ''
...
} satisfies EmbeddedAccountAddressRestrictionTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedAccountAddressRestrictionTransactionDTO
