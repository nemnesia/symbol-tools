...
```typescript
import type { EmbeddedAccountMetadataTransactionDTO } from ''
...
const example = {
  ...
  "value": null,
} satisfies EmbeddedAccountMetadataTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedAccountMetadataTransactionDTO
