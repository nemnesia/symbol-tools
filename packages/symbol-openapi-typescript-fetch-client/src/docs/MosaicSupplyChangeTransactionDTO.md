...
```typescript
import type { MosaicSupplyChangeTransactionDTO } from ''
...
,
  ...
  "delta": 123456,
  "action": null,
} satisfies MosaicSupplyChangeTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as MosaicSupplyChangeTransactionDTO
