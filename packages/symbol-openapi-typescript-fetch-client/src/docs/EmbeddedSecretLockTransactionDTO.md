...
```typescript
import type { EmbeddedSecretLockTransactionDTO } from ''
...
const example = {
  ...
  "duration": 200,
  "hashAlgorithm": null,
} satisfies EmbeddedSecretLockTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedSecretLockTransactionDTO
