...
```typescript
import type { MosaicAddressRestrictionTransactionDTO } from ''
...
} satisfies MosaicAddressRestrictionTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as MosaicAddressRestrictionTransactionDTO
