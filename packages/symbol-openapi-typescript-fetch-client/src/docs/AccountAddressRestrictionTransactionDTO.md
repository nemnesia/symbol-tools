...
```typescript
import type { AccountAddressRestrictionTransactionDTO } from ''
...
} satisfies AccountAddressRestrictionTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as AccountAddressRestrictionTransactionDTO
