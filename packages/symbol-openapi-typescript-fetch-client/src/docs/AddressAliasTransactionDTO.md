...
```typescript
import type { AddressAliasTransactionDTO } from ''
...
,
  ...
  "aliasAction": null,
} satisfies AddressAliasTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as AddressAliasTransactionDTO
