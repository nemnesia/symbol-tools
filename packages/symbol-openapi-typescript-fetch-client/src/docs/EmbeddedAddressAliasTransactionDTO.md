...
```typescript
import type { EmbeddedAddressAliasTransactionDTO } from ''
...
const example = {
  ...
  "aliasAction": null,
} satisfies EmbeddedAddressAliasTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as EmbeddedAddressAliasTransactionDTO
