...
```typescript
import type { MosaicGlobalRestrictionTransactionDTO } from ''
...
} satisfies MosaicGlobalRestrictionTransactionDTO
...
const exampleParsed = JSON.parse(exampleJSON) as MosaicGlobalRestrictionTransactionDTO
